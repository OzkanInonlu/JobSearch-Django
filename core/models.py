...
class Resume(models.Model):
    ...
    upload_resume = models.FileField(upload_to="resume_files", null=True, blank=True)
...
class JobAdvert(models.Model):
    ...
    location = models.CharField(choices=CITIES, max_length=1, null=True, blank=True)
    min_salary = models.PositiveIntegerField(default=0, null=True, blank=True)
    max_salary = models.PositiveIntegerField(null=True, blank=True)
    description = models.TextField(max_length=1000, null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    is_available = models.BooleanField(default=True)
    job_type = models.CharField(choices=JOB_TYPES, max_length=1, null=True, blank=True)
